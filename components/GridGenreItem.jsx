...
function GridGenreItem({genre}) {
  ...
  return (
    ...
    <button onClick={()=>genreStore.setGenre(genre)} className={`w-44 h-44 rounded-lg flex overflow-hidden`} style={{backgroundColor:genre.color}}>
      
      <h1 className='font-gotham text-white text-2xl p-4 font-bold'>{genre.title}</h1>
