  ...
  function handleAllowedClick(id){
    ...
    switch (id) {
      case 2:
        ...
        description = "Kitaplığındaki kayıtlı şarkıları, podcast'leri, sanatçıları ve çalma listelerini görmek için oturum aç."
        break;
      case 3:
      ...
      case 4:
        ...
        description = "Beğendiğin tüm şarkıları kolay bir çalmal listesinde görmek için oturum aç."
        break;
